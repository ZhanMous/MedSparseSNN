...
- mia_attack.py：执行多攻击隐私评估（MIA + 属性推断 + 轻量反演）并输出雷达图。
...
- outputs/csv/mia_results_*.csv：逐次结果。
- outputs/csv/mia_results_*_summary.csv：均值与标准差汇总（含 attr_auc、inversion_risk）。
- outputs/figures/privacy_radar_*_*.png：各模型隐私风险雷达图。
